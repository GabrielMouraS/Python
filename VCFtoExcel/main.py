...
# Função para decodificar strings codificadas em QUOTED-PRINTABLE
...
# Função para ler e processar o arquivo VCF
            ...
            for vcard in vobject.readComponents(vcard_data):
                try:
                    ...
                    if hasattr(vcard, 'tel'):
                        # Remove o '+' e espaços, deixando apenas números
...
# Funções para selecionar arquivo e diretório
def select_vcf():
...
# Campo para selecionar o arquivo VCF
...
# Campo para selecionar o diretório de destino
tk.Label(root, text="Destino:").grid(row=1, column=0, padx=10, pady=10)
entry_output = tk.Entry(root, width=50)
entry_output.insert(0, os.path.expanduser("~/Desktop"))  # Define o diretório padrão como a Área de Trabalho
...
# Checkbox para escolher o formato de saída
